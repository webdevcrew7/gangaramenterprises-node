  ...
  return (
    <>
      ...
      <a href="tel:+919640044469"
        className="floating-contact-buttons fixed bottom-24 right-4 z-[100] md:hidden bg-blue-500 hover:bg-blue-600 text-white w-14 h-14 rounded-full shadow-lg border-2 border-white transition-all duration-300 ease-out flex items-center justify-center hover:shadow-2xl hover:-translate-y-1">
