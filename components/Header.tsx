  ...
  return (
    <header className="site-header fixed top-0 left-0 right-0 z-[9999]">
      ...
      <nav className={`bg-royal-700 border-b border-gold-500/30 transition-all duration-300 ${isScrolled
        ...
        <div className="container mx-auto px-4 py-3 md:py-3 flex justify-center md:justify-between items-center relative">
          ...
          {/* Desktop Menu Links */}
          <div className="desktop-nav hidden md:flex items-center space-x-8 text-sm font-medium text-white">
